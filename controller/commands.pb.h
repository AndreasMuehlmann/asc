...
inline const std::string& Command::msg() const {
  // @@protoc_insertion_point(field_get:proto.Command.msg)
  return _internal_msg();
}
inline void Command::set_msg(const std::string& value) {
  _internal_set_msg(value);
  // @@protoc_insertion_point(field_set:proto.Command.msg)
}
inline std::string* Command::mutable_msg() {
  // @@protoc_insertion_point(field_mutable:proto.Command.msg)
...
inline void Command::set_msg(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:proto.Command.msg)
}
inline void Command::set_msg(const char* value) {
  ...
  msg_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:proto.Command.msg)
}
inline void Command::set_msg(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:proto.Command.msg)
}
...
inline std::string* Command::release_msg() {
  // @@protoc_insertion_point(field_release:proto.Command.msg)
...
inline void Command::set_allocated_msg(std::string* msg) {
  ...
  msg_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), msg,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:proto.Command.msg)
}
inline std::string* Command::unsafe_arena_release_msg() {
  // @@protoc_insertion_point(field_unsafe_arena_release:proto.Command.msg)
...
inline void Command::unsafe_arena_set_allocated_msg(
  ...
  msg_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      msg, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:proto.Command.msg)
}

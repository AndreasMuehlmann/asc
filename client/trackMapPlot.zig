...
pub const TrackMapPlot = struct {
    ...
    pub fn init(plot: Plot) !Self {
        return .{
            .plot = plot,
            .carSheet = try rl.loadTexture("/home/andi/programming/asc/sprites/RacingCars_F1.png"),
        };
    }
    ...
    pub fn clear(self: *Self, dataSetName: []const u8) !void {
        try self.plot.clear(dataSetName);
    }
